...
function onCreatePost()
    ...
    runHaxeCode([[
        ...
        function activateRainShader() FlxG.camera.filters = [new ShaderFilter(game.getLuaObject('rainFilter').shader)];
        function deactivateRainShader() FlxG.camera.filters = [];
		...
		getVar('colorShader').setAdjustColor(-7, -40, -25, -20);
    ...
    setProperty('sprayCans.shader', instanceArg('colorShader'), nil, true)
