...
function onCreate()
	...
	makeLuaSprite('tankSky', 'tankmanBattlefield/tankSky', -400, -400)
	setScrollFactor('tankSky', 0, 0)

	makeLuaSprite('tankBuildings', 'tankmanBattlefield/tankBuildings', -200, 0)
	setScrollFactor('tankBuildings', 0.3, 0.3)
	scaleObject('tankBuildings', 1.1, 1.1)

	makeLuaSprite('tankRuins', 'tankmanBattlefield/tankRuins', -200, 0)
	setScrollFactor('tankRuins', 0.35, 0.35)
	scaleObject('tankRuins', 1.1, 1.1)

	makeAnimatedLuaSprite('tankWatchtower', 'tankmanBattlefield/tankWatchtower', 100, 50)
	addAnimationByPrefix('tankWatchtower', 'idle', 'watchtower', 24, false)
	setScrollFactor('tankWatchtower', 0.5, 0.5)

	makeAnimatedLuaSprite('tankRolling', 'tankmanBattlefield/tankRolling', 300, 300)
	addAnimationByPrefix('tankRolling', 'idle', 'BG tank w lighting', 24, true)
	setScrollFactor('tankRolling', 0.5, 0.5)

	makeLuaSprite('tankGround', 'tankmanBattlefield/tankGround', -420, -150)
	...
	if not lowQuality then
		makeLuaSprite('tankClouds', 'tankmanBattlefield/tankClouds', getRandomInt(-700, -100), getRandomInt(-20, 20))
		setScrollFactor('tankClouds', 0.1, 0.1)
		setProperty('tankClouds.velocity.x', getRandomInt(5, 15))

		makeLuaSprite('tankMountains', 'tankmanBattlefield/tankMountains', -300, -20)
		setScrollFactor('tankMountains', 0.2, 0.2)
		scaleObject('tankMountains', 1.2, 1.2)

		makeAnimatedLuaSprite('smokeLeft', 'tankmanBattlefield/smokeLeft', -200, -100)
		addAnimationByPrefix('smokeLeft', 'idle', 'SmokeBlurLeft')
		setScrollFactor('smokeLeft', 0.4, 0.4)

		makeAnimatedLuaSprite('smokeRight', 'tankmanBattlefield/smokeRight', 1100, -100)
