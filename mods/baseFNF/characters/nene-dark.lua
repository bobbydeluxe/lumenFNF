...
function onCreate()
    addLuaScript('scripts/characters/nene')
end
...
function onCreatePost()
    ...
    addLuaScript('characters/props/abot-stereo-dark')
    callScript('characters/props/abot-stereo-dark', 'createSpeaker', {'nene-dark', 0, 0})
end
